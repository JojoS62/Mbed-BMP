...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_XTAL | USE_PLL_HSI                                                                   // set by target:DEVEBOX_F407VG
#define FIRMWARE_VERSION                                                      "1.62"                                                                                           // set by library:BlackMagicProbe
...
#define MBED_CONF_LWIP_SOCKET_MAX                                             8                                                                                                // set by application[*]
...
#define MBED_CONF_LWIP_TCP_SOCKET_MAX                                         8                                                                                                // set by application[*]
...
#define MBED_CONF_STM32_EMAC_ETH_PHY_ADDRESS                                  1                                                                                                // set by application[DEVEBOX_F407VG]
...
#define MBED_CONF_TARGET_LSE_AVAILABLE                                        0                                                                                                // set by target:DEVEBOX_F407VG
#define MBED_CONF_TARGET_MPU_ROM_END                                          0x0fffffff                                                                                       // set by target:Target
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       ETHERNET                                                                                         // set by target:DEVEBOX_F407VG
...
// Macros
#define ENABLE_DEBUG                                                                                                                                                           // defined by library:BlackMagicProbe
#define MBEDTLS_CIPHER_MODE_CTR                                                                                                                                                // defined by library:SecureStore
#define NO_LIBOPENCM3                                                         true                                                                                             // defined by library:BlackMagicProbe
...
#define PC_HOSTED                                                             true                                                                                             // defined by library:BlackMagicProbe
